<template>
  ...
  <h1 class="text-6xl font-extrabold mb-14 tracking-tight text-white drop-shadow-lg">About me</h1>
    <div class="flex gap-16 mb-16">
      <p class="flex-1 text-white/90 text-lg leading-relaxed drop-shadow-sm">
  ...
  <p class="flex-1 text-white/90 text-lg leading-relaxed drop-shadow-sm">
    ...
    <div class="fixed left-0 bottom-0 w-[38vw] min-w-[320px] max-w-none z-0">
      <img src="../assets/ioartista.png" alt="Artista" class="w-full object-contain opacity-70 transition duration-300" />
    </div>
    <div class="fixed right-0 bottom-0 w-[38vw] min-w-[320px] max-w-none z-0">
    ...
    <h2 class="absolute left-1/2 -translate-x-1/2 top-[80px] w-auto text-4xl md:text-5xl font-bold text-cyan-400 flex justify-center items-center tracking-tight drop-shadow-lg transition duration-300" style="position:absolute;">Il Giusto mix tra artista e nerd.</h2>
        </div>
    </div>
  </section>
</template>